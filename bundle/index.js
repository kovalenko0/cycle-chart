...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isolate = __webpack_require__(121);
	...
	function main(sources) {
	    var x$ = sources.DOM.select('.x').events('change').map(function (ev) {
	        return ev.target.value;
	    });

	    var y$ = sources.DOM.select('.y').events('change').map(function (ev) {
	        return ev.target.value;
	    });

	    var active$ = sources.DOM.select('.active').events('click').map(function (ev) {
	        return ev.target.checked;
	    });

	    var coords$ = _xstream2.default.combine(x$, y$).map(function (_ref) {
	    ...
	    var mainChart = (0, _isolate2.default)(_chart.Chart, 'MainChart')(mainChartSources);
	    var mainChartDom$ = mainChart.DOM;

	    var vdom$ = mainChartDom$.map(function (mainChartDom) {
	        return (0, _dom.div)('.app', [mainChartDom, (0, _dom.input)('.x', { attrs: { type: 'number' } }), (0, _dom.input)('.y', { attrs: { type: 'number' } }), (0, _dom.input)('.active', { attrs: { type: 'checkbox' } }), 'Activate']);
	    });
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var makeHTMLDriver_1 = __webpack_require__(89);
	 ...
	 */
	var mockDOMSource_1 = __webpack_require__(118);
	...
	var hyperscript_helpers_1 = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var transposition_1 = __webpack_require__(88);
	var xstream_adapter_1 = __webpack_require__(5);
	var MapPolyfill = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(36)() ? Map : __webpack_require__(37);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var clear          = __webpack_require__(38)
	  , eIndexOf       = __webpack_require__(40)
	  , setPrototypeOf = __webpack_require__(46)
	  , callable       = __webpack_require__(51)
	  , validValue     = __webpack_require__(39)
	  , d              = __webpack_require__(52)
	  , ee             = __webpack_require__(64)
	  , Symbol         = __webpack_require__(65)
	  , iterator       = __webpack_require__(70)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var value = __webpack_require__(39);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toPosInt = __webpack_require__(41)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isIterable = __webpack_require__(71);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isArguments    = __webpack_require__(72)
	  ...
	  , iterable       = __webpack_require__(70)
	  , iteratorSymbol = __webpack_require__(65).iterator;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var callable = __webpack_require__(51)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(86)('key',
		'value', 'key+value');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xstream_adapter_1 = __webpack_require__(5);
	var transposition_1 = __webpack_require__(88);
	var HTMLSource_1 = __webpack_require__(90);
	var toHTML = __webpack_require__(91);
	/* tslint:disable:no-empty */
	var noop = function () { };
	/* tslint:enable:no-empty */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = __webpack_require__(92);

	module.exports = init([__webpack_require__(96), __webpack_require__(114)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VOID_ELEMENTS = __webpack_require__(94);
	var CONTAINER_ELEMENTS = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var union = __webpack_require__(107);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseIndexOf = __webpack_require__(110),
	    cacheIndexOf = __webpack_require__(111),
	    createCache = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forOwn = __webpack_require__(97);
	var escape = __webpack_require__(104);
	var kebabCase = __webpack_require__(115);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var deburr = __webpack_require__(116),
...
/***/ function(module, exports, __webpack_require__) {
	...
	function model(actions) {
	    return _xstream2.default.combine(actions.coords$, actions.active$).filter(function (_ref) {
	        var _ref2 = _slicedToArray(_ref, 2);
	...
	function view(state$) {
	    return state$.map(function (_ref5) {
	        ...
	        return (0, _dom.div)('.chart', [(0, _dom.div)([x, y].toString()), (0, _dom.div)('.cursor', {
	            style: {
	...
	function intent(domSource) {
	    var activate$ = domSource.select('.chart').events('mousedown').map(function (ev) {
	        return true;
	    });

	    var deactivate$ = domSource.select('.chart').events('mouseup').map(function (ev) {
	        return false;
	    });

	    return {
	        coords$: domSource.select('.chart').events('mousemove').map(function (ev) {
	            return { x: ev.offsetX, y: ev.offsetY };
	        }),
	        active$: _xstream2.default.merge(activate$, deactivate$)
	    };
	}

	function Chart(sources) {
	    var domActions = intent(sources.DOM);

	    var actions = {
	        coords$: _xstream2.default.merge(domActions.coords$, sources.props.coords).startWith({ x: 0, y: 0 }),
	        active$: _xstream2.default.merge(domActions.active$, sources.props.active).startWith(true)
	    };
